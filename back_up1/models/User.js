...
User.associate = (models) => {
  ...
  User.hasOne(models.Expert, { foreignKey: 'user_id', as: 'expertProfile' });
  User.hasOne(models.Parent, { foreignKey: 'user_id', as: 'parentProfile' });
  User.hasMany(models.ClassroomEnrollment, { foreignKey: 'student_id' });
  User.hasMany(models.Classroom, { foreignKey: 'teacher_id' });
  User.hasMany(models.Exam, { foreignKey: 'created_by' });
  User.hasMany(models.CounselingSession, { foreignKey: 'expert_id' });
  User.hasMany(models.CounselingSession, { foreignKey: 'student_id' });
